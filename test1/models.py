...
class MyModel(models.Model):
    ...
    caller_object = GenericForeignKey("caller_type", "caller_id", for_concrete_model=True)
    ...
    receiver_object = GenericForeignKey("receiver_type", "receiver_id", for_concrete_model=True)
